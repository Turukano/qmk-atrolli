...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEF] = LAYOUT(
    ...
    _______,          _______,     _______,      MO(NAV),        MO(SHIF),     KC_DOT,      KC_BSPC,     KC_SPC,      KC_ENT,       _______,     _______,     _______ ),
...
//vielleicht del wieder in BSPC ändern?
  [NAV] = LAYOUT( 
    ...
    MO(FFOX),        _______,      _______,      FN_ZOOMOUT,     FN_ZOOMIN,    _______,     _______,    _______,      _______,      _______,      _______,      _______,
